...
from module_admin.system.controller.electricity_controller import electricityController
from module_admin.system.controller.hbpudept_controller import hbpudeptController
from module_admin.system.controller.hbpuuser_controller import hbpuuserController
...
controller_list = [
    ...
    {'router': electricityController, 'tags': ['湖北理工电表']},
    {'router': hbpuuserController, 'tags': ['湖北理工用户表']},
    {'router': hbpudeptController, 'tags': ['寝室查询表']},
]
